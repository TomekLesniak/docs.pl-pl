...
Oprócz pliku zasobów, który jest kompilowany z aplikacją, można użyć kilku innych magazynów danych na potrzeby informacji o strefie czasowej. Należą do nich:

- Rejestr. Należy pamiętać, że aplikacja powinna używać podkluczy własnego klucza aplikacji do przechowywania niestandardowych danych strefy czasowej, a nie przy użyciu podkluczy HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows NT\CurrentVersion\Time Zones.
...
- To odwołanie do System.Windows.Forms.dll i System.Core.dll zostać dodane do projektu.
