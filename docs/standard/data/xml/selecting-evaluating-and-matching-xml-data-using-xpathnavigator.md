...
## <a name="in-this-section"></a>W tej sekcji  
 ...
 Opisuje zestaw <xref:System.Xml.XPath.XPathNavigator> metod klasy używanych do wybierania zestawu węzłów w <xref:System.Xml.XPath.XPathDocument> <xref:System.Xml.XmlDocument> obiekcie lub przy użyciu wyrażenia XPath.  
