...
6. <span data-ttu-id="79125-112">Element z sekwencją elementów podrzędnych i atrybutów</span><span class="sxs-lookup"><span data-stu-id="79125-112">Element with a sequence of child elements and attributes</span></span>  
...
|<span data-ttu-id="79125-140">XML</span><span class="sxs-lookup"><span data-stu-id="79125-140">XML</span></span>|<span data-ttu-id="79125-141">Schemat</span><span class="sxs-lookup"><span data-stu-id="79125-141">Schema</span></span>|  
|---------|------------|  
...
### <a name="element-with-a-sequence-of-child-elements"></a><span data-ttu-id="79125-142">Element z sekwencją elementów podrzędnych</span><span class="sxs-lookup"><span data-stu-id="79125-142">Element with a Sequence of Child Elements</span></span>  

 <span data-ttu-id="79125-143">W poniższej tabeli przedstawiono dane wejściowe XML do <xref:System.Xml.Schema.XmlSchemaInference.InferSchema%2A> metody i Wygenerowano schemat XML.</span><span class="sxs-lookup"><span data-stu-id="79125-143">The following table shows the XML input to the <xref:System.Xml.Schema.XmlSchemaInference.InferSchema%2A> method, and the XML schema generated.</span></span> <span data-ttu-id="79125-144">Elementy pogrubione pokazują schemat wywnioskowany dla elementu z sekwencją elementów podrzędnych.</span><span class="sxs-lookup"><span data-stu-id="79125-144">The bolded elements show the schema inferred for an element with a sequence of child elements.</span></span>  
  
> [!NOTE]
> <span data-ttu-id="79125-145">Nawet jeśli element ma tylko jeden element podrzędny, jest nadal traktowany jako sekwencja.</span><span class="sxs-lookup"><span data-stu-id="79125-145">Even if an element has only one child element, it is still treated as a sequence.</span></span>  
  
 <span data-ttu-id="79125-146">Aby uzyskać więcej informacji na temat procesu wnioskowania schematu, zobacz [wnioskowanie schematów z dokumentów XML](inferring-schemas-from-xml-documents.md).</span><span class="sxs-lookup"><span data-stu-id="79125-146">For more information about the schema inference process, see [Inferring Schemas from XML Documents](inferring-schemas-from-xml-documents.md).</span></span>  
  
|<span data-ttu-id="79125-147">XML</span><span class="sxs-lookup"><span data-stu-id="79125-147">XML</span></span>|<span data-ttu-id="79125-148">Schemat</span><span class="sxs-lookup"><span data-stu-id="79125-148">Schema</span></span>|  
|---------|------------|  
...
### <a name="element-with-a-sequence-of-child-elements-and-attributes"></a><span data-ttu-id="79125-149">Element z sekwencją elementów podrzędnych i atrybutów</span><span class="sxs-lookup"><span data-stu-id="79125-149">Element with a Sequence of Child Elements and Attributes</span></span>  

 <span data-ttu-id="79125-150">W poniższej tabeli przedstawiono dane wejściowe XML do <xref:System.Xml.Schema.XmlSchemaInference.InferSchema%2A> metody i Wygenerowano schemat XML.</span><span class="sxs-lookup"><span data-stu-id="79125-150">The following table shows the XML input to the <xref:System.Xml.Schema.XmlSchemaInference.InferSchema%2A> method, and the XML schema generated.</span></span> <span data-ttu-id="79125-151">Elementy pogrubione pokazują schemat wywnioskowany dla elementu z sekwencją elementów podrzędnych i atrybutów.</span><span class="sxs-lookup"><span data-stu-id="79125-151">The bolded elements show the schema inferred for an element with a sequence of child elements and attributes.</span></span>  
  
> [!NOTE]
> <span data-ttu-id="79125-152">Nawet jeśli element ma tylko jeden element podrzędny, jest nadal traktowany jako sekwencja.</span><span class="sxs-lookup"><span data-stu-id="79125-152">Even if an element has only one child element, it is still treated as a sequence.</span></span>  
  
 <span data-ttu-id="79125-153">Aby uzyskać więcej informacji na temat procesu wnioskowania schematu, zobacz [wnioskowanie schematów z dokumentów XML](inferring-schemas-from-xml-documents.md).</span><span class="sxs-lookup"><span data-stu-id="79125-153">For more information about the schema inference process, see [Inferring Schemas from XML Documents](inferring-schemas-from-xml-documents.md).</span></span>  
  
|<span data-ttu-id="79125-154">XML</span><span class="sxs-lookup"><span data-stu-id="79125-154">XML</span></span>|<span data-ttu-id="79125-155">Schemat</span><span class="sxs-lookup"><span data-stu-id="79125-155">Schema</span></span>|  
|---------|------------|  
...
### <a name="element-with-a-sequence-and-choices-of-child-elements"></a><span data-ttu-id="79125-156">Element z sekwencją i wyborami elementów podrzędnych</span><span class="sxs-lookup"><span data-stu-id="79125-156">Element with a Sequence and Choices of Child Elements</span></span>  

 <span data-ttu-id="79125-157">W poniższej tabeli przedstawiono dane wejściowe XML do <xref:System.Xml.Schema.XmlSchemaInference.InferSchema%2A> metody i Wygenerowano schemat XML.</span><span class="sxs-lookup"><span data-stu-id="79125-157">The following table shows the XML input to the <xref:System.Xml.Schema.XmlSchemaInference.InferSchema%2A> method, and the XML schema generated.</span></span> <span data-ttu-id="79125-158">Elementy pogrubione pokazują schemat wywnioskowany dla elementu z sekwencją i wyborem elementów podrzędnych.</span><span class="sxs-lookup"><span data-stu-id="79125-158">The bolded elements show the schema inferred for an element with a sequence and choice of child elements.</span></span>  
  
> [!NOTE]
> <span data-ttu-id="79125-159">`maxOccurs`Atrybut `xs:choice` elementu jest ustawiony na `"unbounded"` w wywnioskowanym schemacie.</span><span class="sxs-lookup"><span data-stu-id="79125-159">The `maxOccurs` attribute of the `xs:choice` element is set to `"unbounded"` in the inferred schema.</span></span>  
  
 <span data-ttu-id="79125-160">Aby uzyskać więcej informacji na temat procesu wnioskowania schematu, zobacz [wnioskowanie schematów z dokumentów XML](inferring-schemas-from-xml-documents.md).</span><span class="sxs-lookup"><span data-stu-id="79125-160">For more information about the schema inference process, see [Inferring Schemas from XML Documents](inferring-schemas-from-xml-documents.md).</span></span>  
  
|<span data-ttu-id="79125-161">XML</span><span class="sxs-lookup"><span data-stu-id="79125-161">XML</span></span>|<span data-ttu-id="79125-162">Schemat</span><span class="sxs-lookup"><span data-stu-id="79125-162">Schema</span></span>|  
|---------|------------|  
...
### <a name="element-with-a-sequence-and-choice-of-child-elements-and-attributes"></a><span data-ttu-id="79125-163">Element z sekwencją i wyborem elementów podrzędnych i atrybutów</span><span class="sxs-lookup"><span data-stu-id="79125-163">Element with a Sequence and Choice of Child Elements and Attributes</span></span>  

 <span data-ttu-id="79125-164">W poniższej tabeli przedstawiono dane wejściowe XML do <xref:System.Xml.Schema.XmlSchemaInference.InferSchema%2A> metody i Wygenerowano schemat XML.</span><span class="sxs-lookup"><span data-stu-id="79125-164">The following table shows the XML input to the <xref:System.Xml.Schema.XmlSchemaInference.InferSchema%2A> method, and the XML schema generated.</span></span> <span data-ttu-id="79125-165">Elementy pogrubione pokazują schemat wywnioskowany dla elementu z sekwencją i wyborem elementów podrzędnych i atrybutów.</span><span class="sxs-lookup"><span data-stu-id="79125-165">The bolded elements show the schema inferred for an element with a sequence and choice of child elements and attributes.</span></span>  
...
### <a name="mixed-content"></a><span data-ttu-id="79125-178">Zawartość mieszana</span><span class="sxs-lookup"><span data-stu-id="79125-178">Mixed Content</span></span>  
...
- [<span data-ttu-id="79125-204">Zasady wnioskowania typów prostych</span><span class="sxs-lookup"><span data-stu-id="79125-204">Rules for Inferring Simple Types</span></span>](rules-for-inferring-simple-types.md)
