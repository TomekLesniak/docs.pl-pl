...
---
# <a name="how-to-write-a-linq-to-xml-axis-method-linq-to-xml"></a>Jak napisać metodę osi LINQ to XML (LINQ to XML)

[Metoda osi](linq-xml-axes-overview.md) XML pobiera kolekcję elementów XML z dokumentu XML lub elementu nadrzędnego. Można napisać własne metody osi, aby pobierać kolekcje z drzewa XML. Najlepszym sposobem, aby to zrobić, jest zapisanie metody rozszerzającej zwracającej kolekcję elementów lub atrybutów. Można napisać metodę rozszerzenia w celu zwrócenia określonych podzbiorów elementów lub atrybutów na podstawie wymagań aplikacji. W tym artykule przedstawiono przykład dla języków C# i Visual Basic.
