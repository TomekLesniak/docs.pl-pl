...
---
# <a name="how-to-generate-xml-from-csv-files-linq-to-xml"></a>Jak generować XML z plików CSV (LINQ to XML)

LINQ to XML w języku C# lub Visual Basic służy do tworzenia kodu XML z pliku wartości rozdzielanych przecinkami (CSV).

## <a name="example-generate-xml-from-a-csv-file"></a>Przykład: generowanie XML z pliku CSV

Ten przykład wykonuje zapytanie LINQ na tablicy ciągów, a następnie używa `let` klauzuli, aby podzielić każdy ciąg na tablicę pól.
