---
title: Jak projektować Graf obiektów — LINQ to XML
description: Możesz użyć języka C# lub Visual Basic do projektu lub wypełniania grafu obiektów na podstawie kodu XML. W przykładzie w tym artykule pokazano, jak.
ms.date: 07/20/2015
dev_langs:
- csharp
- vb
...
ms.locfileid: "89553720"
---
# <a name="how-to-project-an-object-graph-linq-to-xml"></a><span data-ttu-id="a9e9b-104">Jak projektować Graf obiektów (LINQ to XML)</span><span class="sxs-lookup"><span data-stu-id="a9e9b-104">How to project an object graph (LINQ to XML)</span></span>

<span data-ttu-id="a9e9b-105">Możesz użyć języka C# lub Visual Basic do projektu lub wypełniania grafu obiektów na podstawie kodu XML.</span><span class="sxs-lookup"><span data-stu-id="a9e9b-105">You can use C# or Visual Basic to project or populate an object graph from XML.</span></span>

## <a name="example-populate-an-object-graph-from-xml"></a><span data-ttu-id="a9e9b-106">Przykład: wypełnianie grafu obiektów z pliku XML</span><span class="sxs-lookup"><span data-stu-id="a9e9b-106">Example: Populate an object graph from XML</span></span>

<span data-ttu-id="a9e9b-107">Ten przykład wypełnia wykres obiektu za pomocą `Address` `PurchaseOrder` klasy,, i `PurchaseOrderItem` z [przykładowego pliku XML dokumentu XML: typowe zamówienie zakupu](sample-xml-file-typical-purchase-order.md).</span><span class="sxs-lookup"><span data-stu-id="a9e9b-107">This example populates an object graph with the `Address`, `PurchaseOrder`, and `PurchaseOrderItem` classes from XML document [Sample XML file: Typical purchase order](sample-xml-file-typical-purchase-order.md).</span></span>
...
<span data-ttu-id="a9e9b-108">Wynik zapytania LINQ jest zwracany jako <xref:System.Collections.Generic.IEnumerable%601> z `PurchaseOrderItem` .</span><span class="sxs-lookup"><span data-stu-id="a9e9b-108">The result of the LINQ query is returned as an <xref:System.Collections.Generic.IEnumerable%601> of `PurchaseOrderItem`.</span></span> <span data-ttu-id="a9e9b-109">Elementy w `PurchaseOrder` klasie są typu <xref:System.Collections.Generic.IEnumerable%601> `PurchaseOrderItem` .</span><span class="sxs-lookup"><span data-stu-id="a9e9b-109">The items in the `PurchaseOrder` class are of type <xref:System.Collections.Generic.IEnumerable%601> of `PurchaseOrderItem`.</span></span> <span data-ttu-id="a9e9b-110">Kod używa <xref:System.Linq.Enumerable.ToList%2A> metody rozszerzającej, aby utworzyć <xref:System.Collections.Generic.List%601> kolekcję na podstawie wyników zapytania.</span><span class="sxs-lookup"><span data-stu-id="a9e9b-110">The code uses the <xref:System.Linq.Enumerable.ToList%2A> extension method to create a <xref:System.Collections.Generic.List%601> collection from the results of the query.</span></span>

<span data-ttu-id="a9e9b-111">Ten przykład generuje następujące wyniki:</span><span class="sxs-lookup"><span data-stu-id="a9e9b-111">This example produces the following output:</span></span>
...
## <a name="see-also"></a><span data-ttu-id="a9e9b-112">Zobacz też</span><span class="sxs-lookup"><span data-stu-id="a9e9b-112">See also</span></span>
