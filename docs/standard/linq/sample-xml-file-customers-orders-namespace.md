---
title: 'Przykładowy plik XML: klienci i zamówienia w przestrzeni nazw — LINQ to XML'
description: Ten plik XML — który jest używany w przykładach — zawiera dane w przestrzeni nazw dotyczące klientów i zamówień.
ms.date: 07/20/2015
...
ms.locfileid: "89553624"
---
# <a name="sample-xml-file-customers-and-orders-in-a-namespace-linq-to-xml"></a><span data-ttu-id="bed13-103">Przykładowy plik XML: klienci i zamówienia w przestrzeni nazw (LINQ to XML)</span><span class="sxs-lookup"><span data-stu-id="bed13-103">Sample XML file: Customers and orders in a namespace (LINQ to XML)</span></span>

<span data-ttu-id="bed13-104">Poniższy plik XML jest używany w różnych przykładach w dokumentacji LINQ to XML.</span><span class="sxs-lookup"><span data-stu-id="bed13-104">The following XML file is used in various examples in the LINQ to XML documentation.</span></span> <span data-ttu-id="bed13-105">Ten plik zawiera klientów i zamówienia.</span><span class="sxs-lookup"><span data-stu-id="bed13-105">This file contains customers and orders.</span></span> <span data-ttu-id="bed13-106">KOD XML znajduje się w przestrzeni nazw.</span><span class="sxs-lookup"><span data-stu-id="bed13-106">The XML is in a namespace.</span></span>

## <a name="customersordersinnamespacexml"></a><span data-ttu-id="bed13-107">CustomersOrdersInNamespace.xml</span><span class="sxs-lookup"><span data-stu-id="bed13-107">CustomersOrdersInNamespace.xml</span></span>
