...
---
# <a name="sample-xml-file-customers-and-orders-in-a-namespace-linq-to-xml"></a>Przykładowy plik XML: klienci i zamówienia w przestrzeni nazw (LINQ to XML)

Poniższy plik XML jest używany w różnych przykładach w dokumentacji LINQ to XML. Ten plik zawiera klientów i zamówienia. KOD XML znajduje się w przestrzeni nazw.
