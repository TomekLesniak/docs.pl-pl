...
---
# <a name="how-to-serialize-using-xmlserializer-linq-to-xml"></a>Jak serializować przy użyciu elementu XmlSerializer (LINQ to XML)

W tym artykule przedstawiono przykład serializacji i deserializacji przy użyciu <xref:System.Xml.Serialization.XmlSerializer> języka C# i Visual Basic.
