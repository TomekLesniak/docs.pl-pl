...
Przykład otwiera pakiet Office Open XML i używa relacji w pakiecie do znajdowania dokumentu i elementów stylu. Następnie wysyła zapytanie do dokumentu i projektów kolekcji zawierającej informacje o akapicie. Każdy obiekt kolekcji reprezentuje akapit i zawiera węzeł akapitu <xref:System.Xml.Linq.XElement> , nazwę stylu i tekst.
