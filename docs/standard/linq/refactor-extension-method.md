...
---
# <a name="refactor-using-an-extension-method-linq-to-xml"></a>Refaktoryzacja przy użyciu metody rozszerzającej (LINQ to XML)

Ten przykład kompiluje się w poprzednim przykładzie, [Pobiera tekst akapitów](retrieve-text-paragraphs.md)przez refaktoryzację łączenia ciągów przy użyciu czystej funkcji, która jest zaimplementowana jako Metoda rozszerzenia.
...
## <a name="example-retrieve-the-paragraphs-their-styles-and-their-text"></a>Przykład: pobieranie akapitów, ich stylów i tekstu

Ten przykład przetwarza dokument WordprocessingML, pobierając akapity oraz styl i tekst dla każdego akapitu. Ten przykład kompiluje się zgodnie z poprzednimi przykładami w tym samouczku.
...
## <a name="example-use-all-four-overloads-of-the-stringconcatenate-method"></a>Przykład: Użyj wszystkich czterech przeciążeń `StringConcatenate` metody
...
## <a name="example-use-the-new-extension-method"></a>Przykład: Użyj nowej metody rozszerzenia
...
Ta refaktoryzacja jest wariantem refaktoryzacji w czystej funkcji. W następnym artykule z tego samouczka przedstawiono bardziej szczegółowo sposób refaktoryzacji tego kodu w postaci czystych funkcji:
