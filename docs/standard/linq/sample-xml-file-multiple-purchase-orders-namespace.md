...
---
# <a name="sample-xml-file-multiple-purchase-orders-in-a-namespace-linq-to-xml"></a>Przykładowy plik XML: wiele zamówień zakupu w przestrzeni nazw (LINQ to XML)

Poniższy plik XML jest używany w różnych przykładach w dokumentacji LINQ to XML. Ten plik zawiera kilka zamówień zakupu. KOD XML znajduje się w przestrzeni nazw.
