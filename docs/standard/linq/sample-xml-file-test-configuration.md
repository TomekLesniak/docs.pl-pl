...
---
# <a name="sample-xml-file-test-configuration-linq-to-xml"></a>Przykładowy plik XML: Konfiguracja testu (LINQ to XML)

Poniższy plik XML jest używany w różnych przykładach w dokumentacji LINQ to XML. To jest plik konfiguracji testu.
