...
Ale aby użyć poprzedzającego kodu, należy również podać nazwę zestawu w wierszu polecenia. W wierszu polecenia wprowadź następujące polecenie (zakładając, że plik XML ma nazwę GenerateSchemaFromType.xml):
