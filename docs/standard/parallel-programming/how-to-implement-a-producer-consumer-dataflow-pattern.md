...
W tym artykule dowiesz się, jak używać biblioteki TPL przepływu danych do implementowania wzorca producenta. W tym wzorcu *producent* wysyła komunikaty do bloku komunikatów, a *konsument* odczytuje komunikaty z tego bloku.
