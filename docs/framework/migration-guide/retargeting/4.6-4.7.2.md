---
title: Przekierowywanie zmian dotyczących migracji z .NET Framework 4,6 do 4.7.2
description: Znajdź informacje o problemach ze zgodnością aplikacji, które mogą mieć wpływ na aplikację podczas migrowania z .NET Framework 4,6 do 4.7.2.
ms.date: 07/10/2019
...
ms.locfileid: "95724042"
---
# <a name="retargeting-changes-for-migration-from-net-framework-46-to-472"></a><span data-ttu-id="66f5e-103">Przekierowywanie zmian dotyczących migracji z .NET Framework 4,6 do 4.7.2</span><span class="sxs-lookup"><span data-stu-id="66f5e-103">Retargeting Changes for Migration from .NET Framework 4.6 to 4.7.2</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/retargeting/versionselector.md)]

<span data-ttu-id="66f5e-104">W przypadku migrowania z .NET Framework 4,6 do usługi 4.7.2 zapoznaj się z następującymi tematami dotyczącymi problemów ze zgodnością aplikacji, które mogą mieć wpływ na aplikację:</span><span class="sxs-lookup"><span data-stu-id="66f5e-104">If you are migrating from the .NET Framework 4.6 to 4.7.2, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="aspnet"></a><span data-ttu-id="66f5e-105">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="66f5e-105">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="66f5e-106">Core</span><span class="sxs-lookup"><span data-stu-id="66f5e-106">Core</span></span>
...
## <a name="networking"></a><span data-ttu-id="66f5e-107">Sieć</span><span class="sxs-lookup"><span data-stu-id="66f5e-107">Networking</span></span>
...
## <a name="security"></a><span data-ttu-id="66f5e-108">Zabezpieczenia</span><span class="sxs-lookup"><span data-stu-id="66f5e-108">Security</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="66f5e-109">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="66f5e-109">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-forms"></a><span data-ttu-id="66f5e-110">Windows Forms</span><span class="sxs-lookup"><span data-stu-id="66f5e-110">Windows Forms</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="66f5e-111">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="66f5e-111">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="windows-workflow-foundation-wf"></a><span data-ttu-id="66f5e-112">Program Windows Workflow Foundation (WF)</span><span class="sxs-lookup"><span data-stu-id="66f5e-112">Windows Workflow Foundation (WF)</span></span>
