...
---
# <a name="retargeting-changes-for-migration-from-net-framework-462-to-48"></a>Przekierowywanie zmian dotyczących migracji z .NET Framework 4.6.2 do 4,8

[!INCLUDE[versionselector](../../../../includes/migration-guide/retargeting/versionselector.md)]

W przypadku migrowania z .NET Framework 4.6.2 do 4,8 zapoznaj się z następującymi tematami dotyczącymi problemów ze zgodnością aplikacji, które mogą mieć wpływ na aplikację:
