...
> [!NOTE]
> Debugowanie <xref:System.ServiceProcess.ServiceBase.OnStart%2A> metody może być trudne, ponieważ Menedżer kontroli usług nakłada limit 30 sekund na wszystkie próby uruchomienia usługi. Aby uzyskać więcej informacji, zobacz [Rozwiązywanie problemów: debugowanie usług systemu Windows](troubleshooting-debugging-windows-services.md).  
...
6. Na pasku menu wybierz polecenie **Dołącz do procesu** z menu **debugowanie** lub **Narzędzia** . (Klawiatura: Ctrl + Alt + P)  
