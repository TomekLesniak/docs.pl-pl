...
|<xref:System.Windows.Automation.AutomationElementIdentifiers.LabeledByProperty>|Zero|Kontrolki przycisku podziału nie mają statycznej etykiety tekstowej.|  
...
|---------------------|-------------|-----------|  
|<xref:System.Windows.Automation.Provider.IInvokeProvider>|Wymagany|Przyciski podziału zawsze mają domyślną akcję skojarzoną z wywołaniem Invoke.|  
|<xref:System.Windows.Automation.Provider.IExpandCollapseProvider>|Wymagany|Przyciski Split zawsze mają możliwość rozwinięcia listy opcji.|  
