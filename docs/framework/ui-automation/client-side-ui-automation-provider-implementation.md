...
## <a name="distributing-client-side-providers"></a>Dystrybuowanie dostawców Client-Side  
...
## <a name="registering-and-configuring-client-side-providers"></a>Rejestrowanie i Konfigurowanie dostawców Client-Side  
