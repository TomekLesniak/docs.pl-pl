...
|---------------------|-------------|-----------|  
|<xref:System.Windows.Automation.Provider.IToggleProvider>|Wymagany|Umożliwia programistyczne przechodzenie pola wyboru przy użyciu jego Stanów wewnętrznych.|  
...
|<xref:System.Windows.Automation.TogglePatternIdentifiers.ToggleStateProperty> zdarzenie zmiany właściwości.|Wymagany|Brak|  
