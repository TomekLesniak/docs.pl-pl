...
### <a name="respect-all-system-wide-settings-and-do-not-interfere-with-accessibility-functions"></a>Uwzględnij wszystkie ustawienia System-Wide i nie zakłócaj działania funkcji ułatwień dostępu  
...
### <a name="provide-user-selectable-equivalents-for-non-text-elements"></a>Podaj User-Selectable odpowiedniki dla elementów innych niż tekstowe  
...
### <a name="use-standard-input-apis-with-device-independent-calls"></a>Używanie standardowych interfejsów API danych wejściowych z wywołaniami Device-Independent  
