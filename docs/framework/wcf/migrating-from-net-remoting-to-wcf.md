...
|Format wiadomości|Prywatne|Standardy branżowe (SOAP, WS-* itp.)|  
...
#### <a name="scenario-3-client-sends-server-a-by-value-instance"></a>Scenariusz 3: klient wysyła wystąpienie By-Value serwera  
