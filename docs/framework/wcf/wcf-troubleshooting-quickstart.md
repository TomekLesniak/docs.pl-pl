...
6. [Gdy zgłaszam wyjątek FaultException \<Exception> , którego typ jest wyjątkiem, zawsze otrzymuję ogólny typ błęduexception na kliencie, a nie typ ogólny. Co się dzieje?](#BKMK_q5)  
...
- Jeśli klient korzysta z poświadczeń systemu Windows, a wyjątek to a <xref:System.ServiceModel.Security.SecurityNegotiationException> , skonfiguruj Kerberos w następujący sposób.  
...
- [Rejestrowanie nazw głównych usługi Kerberos przy użyciu Http.sys](/previous-versions/sql/sql-server-2008-r2/ms178119(v=sql.105))  
