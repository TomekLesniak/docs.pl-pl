...
---
# <a name="general-reference"></a><span data-ttu-id="e7999-102">Informacje ogólne</span><span class="sxs-lookup"><span data-stu-id="e7999-102">General Reference</span></span>

<span data-ttu-id="e7999-103">W sekcji [\<system.serviceModel>](../configure-apps/file-schema/wcf/system-servicemodel.md) opisano elementy, które są używane do konfigurowania klientów i usług Windows Communication Foundation (WCF).</span><span class="sxs-lookup"><span data-stu-id="e7999-103">The section [\<system.serviceModel>](../configure-apps/file-schema/wcf/system-servicemodel.md) describes the elements that are used to configure Windows Communication Foundation (WCF) clients and services.</span></span>
