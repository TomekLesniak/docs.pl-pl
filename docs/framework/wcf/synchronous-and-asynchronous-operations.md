...
#### <a name="task-based-asynchronous-pattern"></a>Task-Based wzorzec asynchroniczny  
...
```  
 ...
 Operacja SampleMethodTaskAsync zwraca zadanie \<string> , ponieważ operacja logiczna zwraca ciąg. Aby uzyskać więcej informacji na temat wzorca asynchronicznego opartego na zadaniach, zobacz [Task-Based wzorzec asynchroniczny](https://go.microsoft.com/fwlink/?LinkId=232504).  
...
#### <a name="event-based-asynchronous-pattern"></a>Event-Based wzorzec asynchroniczny  
...
```  
 ...
 Aby uzyskać więcej informacji na temat wzorca asynchronicznego opartego na zdarzeniach, zobacz [Event-Based wzorzec asynchroniczny](../../standard/asynchronous-programming-patterns/event-based-asynchronous-pattern-overview.md).  
...
### <a name="client-side-asynchronous-invocations"></a>Client-Side asynchroniczne wywołania  
...
### <a name="one-way-message-exchange-patterns"></a>Wzorce wymiany komunikatów One-Way  
