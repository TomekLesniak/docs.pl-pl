...
```  
 ...
 Aby uzyskać więcej informacji na temat Netsh.exe, zobacz [jak używać narzędzia Netsh.exe i Command-Line przełączników](/previous-versions/tn-archive/bb490939(v=technet.10)).  
