...
## <a name="description"></a>Opis  
 ...
 To zdarzenie jest emitowane po rozpoczęciu generowania kodu XML.  
  
## <a name="message"></a>Wiadomość  

 Generuj kod XML możliwy do serializacji dla "%1".  
