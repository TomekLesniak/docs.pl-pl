...
## <a name="description"></a>Opis  
 ...
 To zdarzenie jest emitowane, gdy Dyspozytor rozpoczął deserializacji komunikatu żądania.  
  
## <a name="message"></a>Wiadomość  

 Dyspozytor rozpoczął deserializacja komunikatu żądania.  
