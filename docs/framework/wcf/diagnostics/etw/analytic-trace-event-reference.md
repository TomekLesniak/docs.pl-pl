...
|[1416 — MaxReceivedMessageSizeExceeded](1416-maxreceivedmessagesizeexceeded.md)|Błąd|%1|limit przydziału|  
|[1417 — MaxSentMessageSizeExceeded](1417-maxsentmessagesizeexceeded.md)|Błąd|%1|limit przydziału|  
|[1418 — MaxOutboundConnectionsPerEndpointExceeded](1418-maxoutboundconnectionsperendpointexceeded.md)|Informacje|%1|limit przydziału|  
|[1419 — MaxPendingConnectionsExceeded](1419-maxpendingconnectionsexceeded.md)|Informacje|%1|limit przydziału|  
|[1420 — ReaderQuotaExceeded](1420-readerquotaexceeded.md)|Błąd|%1|limit przydziału|  
|[1422 — NegotiateTokenAuthenticatorStateCacheExceeded](1422-negotiatetokenauthenticatorstatecacheexceeded.md)|Błąd|%1|limit przydziału|  
|[1423 — NegotiateTokenAuthenticatorStateCacheRatio](1423-negotiatetokenauthenticatorstatecacheratio.md)|Pełny|Współczynnik pamięci podręcznej stanu wystawcy negocjowania tokenu: %1/%2|limit przydziału|  
|[1424 — SecuritySessionRatio](1424-securitysessionratio.md)|Pełny|Współczynnik sesji zabezpieczeń: %1/%2|limit przydziału|  
|[1430 — PendingConnectionsRatio](1430-pendingconnectionsratio.md)|Pełny|Współczynnik oczekujących połączeń: %1/%2|limit przydziału|  
|[1431 — ConcurrentCallsRatio](1431-concurrentcallsratio.md)|Pełny|Współczynnik współbieżnych sesji: %1/%2|limit przydziału|  
|[1432 — ConcurrentSessionsRatio](1432-concurrentsessionsratio.md)|Pełny|Współczynnik współbieżnych sesji: %1/%2|limit przydziału|  
|[1433 — OutboundConnectionsPerEndpointRatio](1433-outboundconnectionsperendpointratio.md)|Pełny|Współczynnik połączeń wychodzących na punkt końcowy: %1/%2|limit przydziału|  
|[1436 — PendingMessagesPerChannelRatio](1436-pendingmessagesperchannelratio.md)|Pełny|Współczynnik komunikatów oczekujących na kanał: %1/%2|limit przydziału|  
|[1438 — ConcurrentInstancesRatio](1438-concurrentinstancesratio.md)|Pełny|Współczynnik współbieżnych wystąpień: %1/%2|limit przydziału|  
|[1439 — PendingAcceptsAtZero](1439-pendingacceptsatzero.md)|Informacje|Brak oczekujących zaakceptowanych od zera|limit przydziału|  
|[1441 — MaxSessionSizeReached](1441-maxsessionsizereached.md)|Ostrzeżenie|1%|limit przydziału|  
|[1442 — ReceiveRetryCountReached](1442-receiveretrycountreached.md)|Ostrzeżenie|Osiągnięto liczbę ponownych prób odebrania komunikatu MSMQ o identyfikatorze "%1"|limit przydziału|  
|[1443 — MaxRetryCyclesExceededMsmq](1443-maxretrycyclesexceededmsmq.md)|Błąd|Przekroczono maksymalną liczbę cykli ponawiania prób w wiadomości MSMQ o identyfikatorze "%1".|limit przydziału|  
|[1445 — ReadPoolMiss](1445-readpoolmiss.md)|Pełny|Utworzono nowy element "%1"|limit przydziału|  
|[1446 — WritePoolMiss](1446-writepoolmiss.md)|Pełny|Utworzono nowy element "%1"|limit przydziału|  
|[1451 — MaxRetryCyclesExceeded](1451-maxretrycyclesexceeded.md)|Błąd|1%|limit przydziału|  
|[3300 — ReceiveContextCompleteFailed](3300-receivecontextcompletefailed.md)|Ostrzeżenie|Nie można ukończyć %1.|Kanał|  
|[3301 — ReceiveContextAbandonFailed](3301-receivecontextabandonfailed.md)|Ostrzeżenie|Nie można porzucić %1.|Kanał|  
...
|[3303 - ReceiveContextAbandonWithException](3303-receivecontextabandonwithexception.md)|Informacje|%1 został porzucony z wyjątkiem %2.|Kanał|  
...
|[3312 — MessageReadByEncoder](3312-messagereadbyencoder.md)|Informacje|Koder odczytał komunikat o rozmiarze %1 b.|Kanał|  
|[3312 — MessageReadByEncoder](3312-messagereadbyencoder.md)|Informacje|Koder zapisał komunikat o rozmiarze %1 b.|Kanał|  
...
|[3321 — ConnectionPoolMiss](3321-connectionpoolmiss.md)|Pełny|Pula dla %1 nie ma dostępnego połączenia i %2 zajętych połączeń.|Kanał|  
...
|[3337 — ChannelReceiveStart](3337-channelreceivestart.md)|Pełny|ChannelHandlerId: %1 — uruchomiono pętlę odbierania komunikatów.|Kanał|  
|[3338 — ChannelReceiveStop](3338-channelreceivestop.md)|Pełny|ChannelHandlerId: %1 — zatrzymano pętlę odbierania komunikatów.|Kanał|  
|[3339 — ChannelFactoryCreated](3339-channelfactorycreated.md)|Pełny|Utworzono obiekt ChannelFactory.|Modelu|  
|[3340 — PipeConnectionAcceptStart](3340-pipeconnectionacceptstart.md)|Pełny|Rozpoczęto akceptowanie połączenia potoku w %1.|Kanał|  
|[3341 — PipeConnectionAcceptStop](3341-pipeconnectionacceptstop.md)|Pełny|Połączenie potoku zostało zaakceptowane.|Kanał|  
|[3342 — EstablishConnectionStart](3342-establishconnectionstart.md)|Pełny|Rozpoczęto ustanawianie połączenia dla %1.|Kanał|  
|[3343 — EstablishConnectionStop](3343-establishconnectionstop.md)|Pełny|Nawiązano połączenie.|Kanał|  
|[3345 — SessionPreambleUnderstood](3345-sessionpreambleunderstood.md)|Pełny|Nazwa preambuły sesji dla ' %1 ' została rozpoznana.|Kanał|  
|[3346 — ConnectionReaderSendFault](3346-connectionreadersendfault.md)|Błąd|Wystąpił błąd podczas wysyłania czytnika połączeń ' %1 '.|Kanał|  
|[3347 — SocketAcceptClosed](3347-socketacceptclosed.md)|Pełny|Zamknął zaakceptowanie gniazda.|TCP|  
|[3348 — ServiceHostFaulted](3348-servicehostfaulted.md)|Krytyczne|Błąd hosta usługi.|TCP|  
|[3349 — ListenerOpenStart](3349-listeneropenstart.md)|Pełny|Otwieranie odbiornika dla ' %1 '.|Kanał|  
|[3350 — ListenerOpenStop](3350-listeneropenstop.md)|Pełny|Ukończono otwieranie odbiornika.|Kanał|  
|[3351 — ServerMaxPooledConnectionsQuotaReached](3351-servermaxpooledconnectionsquotareached.md)|Pełny|Osiągnięto przydział maksymalnej liczby połączeń obsługiwanych przez pule serwera.|limit przydziału|  
...
|[3367 — ConnectionPoolPreambleFailed](3367-connectionpoolpreamblefailed.md)|Błąd|ConnectionPoolPreambleFailed.|Kanał|  
...
|[3370 — BinaryMessageEncodingStart](3370-binarymessageencodingstart.md)|Pełny|Obiekt BinaryMessageEncoder rozpoczął rozpoczął kodowanie komunikatu.|Kanał|  
|[3371 — MtomMessageEncodingStart](3371-mtommessageencodingstart.md)|Pełny|Obiekt mtommessageencoder rozpoczął rozpoczął kodowanie komunikatu.|Kanał|  
|[3372 — TextMessageEncodingStart](3372-textmessageencodingstart.md)|Pełny|Obiekt textmessageencoder rozpoczął rozpoczął kodowanie komunikatu.|Kanał|  
|[3373 — BinaryMessageDecodingStart](3373-binarymessagedecodingstart.md)|Pełny|Obiekt BinaryMessageEncoder rozpoczął rozpoczął dekodowanie komunikatu.|Kanał|  
|[3374 — MtomMessageDecodingStart](3374-mtommessagedecodingstart.md)|Pełny|Obiekt mtommessageencoder rozpoczął rozpoczął dekodowanie komunikatu.|Kanał|  
|[3375 — TextMessageDecodingStart](3375-textmessagedecodingstart.md)|Pełny|Obiekt textmessageencoder rozpoczął rozpoczął dekodowanie komunikatu.|Kanał|  
...
|[3381 — SequenceAcknowledgementSent](3381-sequenceacknowledgementsent.md)|Pełny|Wysłano potwierdzenie sesji SessionId: %1.|Kanał|  
|[3382 — ClientReliableSessionReconnect](3382-clientreliablesessionreconnect.md)|Informacje|Ponowne nawiązywanie połączenia z identyfikatorem sesji: %1.|Kanał|  
|[3383 — ReliableSessionChannelFaulted](3383-reliablesessionchannelfaulted.md)|Informacje|Błąd sesji SessionId: %1.|Kanał|  
...
|[3389 — ClientSendPreambleStart](3389-clientsendpreamblestart.md)|Pełny|Klient rozpoczął wysyłanie preambuły.|Kanał|  
|[3390 — ClientSendPreambleStop](3390-clientsendpreamblestop.md)|Pełny|Klient zatrzymał wysyłanie preambuły.|Kanał|  
...
|[3393 — StreamedMessageReadByEncoder](3393-streamedmessagereadbyencoder.md)|Informacje|Koder odczytał komunikat przesyłany strumieniowo.|Kanał|  
|[3394 — StreamedMessageWrittenByEncoder](3394-streamedmessagewrittenbyencoder.md)|Informacje|Koder zapisał komunikat przesyłany strumieniowo.|Kanał|  
|[3395 — MessageWrittenAsynchronouslyByEncoder](3395-messagewrittenasynchronouslybyencoder.md)|Informacje|Koder zapisał komunikat asynchronicznie.|Kanał|  
|[3396 — BufferedAsyncWriteStart](3396-bufferedasyncwritestart.md)|Informacje|Buforze BufferId: %1 zakończył zapisywanie bajtów "%2" w strumieniu bazowym.|Kanał|  
|[3397 — BufferedAsyncWriteStop](3397-bufferedasyncwritestop.md)|Informacje|Koder zapisał komunikat asynchronicznie.|Kanał|  
|[3398 — PipeSharedMemoryCreated](3398-pipesharedmemorycreated.md)|Pełny|Udostępniona pamięć potoku została utworzona w lokalizacji "%1".|Kanał|  
|[3399 — NamedPipeCreated](3399-namedpipecreated.md)|Pełny|Utworzono nazwany potok ' %1 '.|Kanał|  
...
|[3554 — XamlServicesLoadStop](3554-xamlservicesloadstop.md)|Informacje|XamlServicesLoad Zatrzymaj|WebHost|  
...
|[3560 — ServiceActivationAvailableMemory](3560-serviceactivationavailablememory.md)|Pełny|Dostępna pamięć (w bajtach): %1|limit przydziału|  
...
|[4002 — FailFastException](4002-failfastexception.md)|Krytyczne|FailFastException.|ActivationServices|  
...
|[4032 — WasConnectionTimedout](4032-wasconnectiontimedout.md)|Krytyczne|Przekroczono limit czasu połączenia.|ActivationServices|  
...
|[4035 — PendingSessionQueueRatio](4035-pendingsessionqueueratio.md)|Pełny|Współczynnik kolejki sesji oczekujących: %1/%2|limit przydziału|  
...
|[5203 — JsonMessageDecodingStart](5203-jsonmessagedecodingstart.md)|Pełny|Obiekt jsonmessageencoder rozpoczął rozpoczął dekodowanie komunikatu.|Kanał|  
|[5204 — JsonMessageEncodingStart](5204-jsonmessageencodingstart.md)|Pełny|Obiekt jsonmessageencoder rozpoczął rozpoczął kodowanie komunikatu.|Kanał|  
...
|[57397 — UnhandledException](57397-unhandledexception.md)|Krytyczne|Nieobsługiwany wyjątek.|Infrastruktura|  
|[57399 — TraceCodeEventLogCritical](57399-tracecodeeventlogcritical.md)|Krytyczne|Zapisano w dzienniku zdarzeń.|Infrastruktura|  
