...
## <a name="configuring-transactionprotocol"></a>Konfigurowanie element TransactionProtocol  
 ...
 Poniżej znajduje się przykład sekcji konfiguracji, która umożliwia skonfigurowanie określonego powiązania do obsługi przepływu transakcji, a także użycie protokołu WS-AtomicTransaction.  
...
- [Schemat konfiguracji WCF](../../configure-apps/file-schema/wcf/index.md)
