...
## <a name="application-specific-dead-letter-queue"></a>Kolejka Dead-Letter Application-Specific  
...
## <a name="poison-message-handling"></a>Obsługa Poison-Message  
