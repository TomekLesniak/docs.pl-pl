...
|-------------|---------------------------|-----------------|  
|<xref:System.ServiceModel.BasicHttpBinding>|[\<basicHttpBinding>](../../configure-apps/file-schema/wcf/basichttpbinding.md)|Powiązanie, które jest odpowiednie do komunikacji z usługami sieci Web zgodnymi z profilem WS-Basic, na przykład usługi ASP.NET Web Services (ASMX). To powiązanie używa protokołu HTTP jako transportu i tekstu/XML jako domyślnego kodowania wiadomości.|  
...
|-------------|----------------------|----------------------------------|-----------------------------|------------------|------------|  
|<xref:System.ServiceModel.BasicHttpBinding>|Profil podstawowy 1,1|(Brak), transport, komunikat, mieszany|Brak, (brak)|(Brak)|n/d|  
...
|<xref:System.ServiceModel.WebHttpBinding>|.Net|Brak, transport, TransportCredentialOnly|(Brak)|(Brak)|n/d|  
|<xref:System.ServiceModel.MsmqIntegration.MsmqIntegrationBinding>|Usługa MSMQ|Brak, (transport)|(Brak)|(Brak), tak|n/d|  
