...
W tym temacie opisano, jak używać różnych przełączników w Svcutil.exe do generowania klientów z dokumentów metadanych.  
 ...
 Dokumenty metadanych mogą znajdować się w magazynie trwałym lub być pobierane w trybie online. Pobieranie online odbywa się przy użyciu protokołu WS-MetadataExchange lub protokołu Microsoft Discovery (DISCO). W celu pobierania metadanych Svcutil.exe wystawić następujące żądania metadanych jednocześnie:  
