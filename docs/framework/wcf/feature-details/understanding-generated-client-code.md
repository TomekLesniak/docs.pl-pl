...
ms.locfileid: "96281628"
---
# <a name="understanding-generated-client-code"></a>Opis wygenerowanego kodu klienta

[Narzędzie do przesyłania metadanych modelu ServiceModel (Svcutil.exe)](../servicemodel-metadata-utility-tool-svcutil-exe.md) generuje kod klienta i plik konfiguracji aplikacji klienckiej do użycia podczas tworzenia aplikacji klienckich. Ten temat zawiera Przewodnik po wygenerowanych przykładach kodu dla standardowych scenariuszy kontraktu usługi. Aby uzyskać więcej informacji na temat tworzenia aplikacji klienckiej przy użyciu wygenerowanego kodu, zobacz [Omówienie klienta WCF](../wcf-client-overview.md).  
...
## <a name="overview"></a>Omówienie  
 ...
 Ponieważ Svcutil.exe zawiera wiele opcji, które modyfikują wygenerowane informacje o typie, ten temat nie obejmuje wszystkich scenariuszy. Jednak następujące zadania standardowe obejmują lokalizowanie wygenerowanego kodu:  
