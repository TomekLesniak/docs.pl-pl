...
- Użytkownik domeny: konto użytkownika w domenie systemu Windows. Przykład: `DomainName\ProfileName`.  
  
- Komputer domeny: proces z tożsamością komputera uruchomioną na komputerze przyłączonym do domeny systemu Windows. Przykład: `MachineName\Network Service`.  
