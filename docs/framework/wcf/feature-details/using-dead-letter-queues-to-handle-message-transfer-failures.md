...
## <a name="specifying-use-of-the-dead-letter-queue"></a>Określanie użycia kolejki Dead-Letter  
...
## <a name="reading-messages-from-the-dead-letter-queue"></a>Odczytywanie wiadomości z kolejki Dead-Letter  
...
## <a name="poison-message-handling-from-the-dead-letter-queue"></a>Obsługa skażonych komunikatów z kolejki Dead-Letter  
