...
## <a name="service-hosts-in-iis-hosted-applications"></a>Hosty usług w aplikacjach IIS-Hosted  
...
## <a name="uris-and-iis-hosted-endpoints"></a>Identyfikatory URI i IIS-Hosted punkty końcowe  
...
## <a name="optimizing-performance-in-middle-tier-scenarios"></a>Optymalizacja wydajności w scenariuszach Middle-Tier  
