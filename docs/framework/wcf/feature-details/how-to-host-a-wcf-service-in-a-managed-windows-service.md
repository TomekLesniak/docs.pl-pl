...
6. Zdefiniuj `ICalculator` kontrakt usługi, jak pokazano w poniższym kodzie.
...
9. Zastąp <xref:System.ServiceProcess.ServiceBase.OnStart%28System.String%5B%5D%29> metodę, tworząc i otwierając nowe <xref:System.ServiceModel.ServiceHost> wystąpienie, jak pokazano w poniższym kodzie.
...
12. Usuń `Service` klasę, która została wygenerowana podczas tworzenia projektu.
