...
|Metoda|Opis|  
|------------|-----------------|  
|[IsFullyTrusted, metoda](icordebugassembly2-isfullytrusted-method.md)|Pobiera wartość wskazującą, czy zestaw ma przyznane pełne zaufanie przez system zabezpieczeń środowiska uruchomieniowego.|  
