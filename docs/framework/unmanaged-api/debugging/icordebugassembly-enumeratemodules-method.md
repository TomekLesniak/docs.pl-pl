...
Pobiera moduł wyliczający dla modułów zawartych w `ICorDebugAssembly` .  
...
## <a name="parameters"></a>Parametry  
 ...
 `ppModules`  
 określoną Wskaźnik do adresu interfejsu ICorDebugModuleEnum, który jest modułem wyliczającym.  
