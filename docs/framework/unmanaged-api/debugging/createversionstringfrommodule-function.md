...
## <a name="return-value"></a>Wartość zwracana  
 ...
 `pdwLength` jest większa niż `cchBuffer` . Może to być oczekiwany wynik, jeśli przeszedł wartość null dla obu `pBuffer` i `cchBuffer` , i zbadano wymagany rozmiar buforu przy użyciu `pdwLength` .  
