...
|Metoda|Opis|  
|------------|-----------------|  
|[GetVirtualMethodAndType, metoda](icordebugobjectvalue2-getvirtualmethodandtype-method.md)|`GetVirtualMethodAndType` nie została jeszcze zaimplementowana.|  
