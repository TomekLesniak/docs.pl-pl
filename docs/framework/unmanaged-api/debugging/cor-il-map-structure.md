...
## <a name="remarks"></a>Uwagi  
 ...
 Format mapy jest następujący: debuger przyjmie, że `oldOffset` odwołuje się do przesunięcia MSIL w oryginalnym, niezmodyfikowanym kodzie MSIL. `newOffset`Parametr odnosi się do odpowiedniego przesunięcia MSIL w nowym, Instrumentacji kodu.  
