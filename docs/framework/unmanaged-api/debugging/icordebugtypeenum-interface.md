...
|Metoda|Opis|  
|------------|-----------------|  
|[Next, metoda](icordebugtypeenum-next-method.md)|Pobiera określoną liczbę `ICorDebugType` wystąpień z wyliczenia, rozpoczynając od bieżącego położenia.|  
