...
## <a name="remarks"></a>Uwagi  
 ...
 Parametry tej metody są takie same jak w przypadku `CreateProcess` metody Win32.  
  
 Aby włączyć debugowanie w trybie mieszanym, ustaw opcję `dwCreationFlags` na DEBUG_PROCESS &#124; DEBUG_ONLY_THIS_PROCESS. Jeśli chcesz używać tylko debugowania zarządzanego, nie ustawiaj tych flag.  
