...
Pobiera wskaźnik interfejsu do procesu, w którym działa to wystąpienie ICorDebugAssembly.  
...
## <a name="parameters"></a>Parametry  
 ...
 `ppProcess`  
 określoną Wskaźnik do interfejsu ICorDebugProcess, który reprezentuje proces.  
