...
## <a name="parameters"></a>Parametry  
 ...
 `cMax`  
 podczas Maksymalny rozmiar `rTypeRefs` tablicy.  
...
|HRESULT|Opis|  
|-------------|-----------------|  
|`S_OK`|`EnumTypeRefs` pomyślnie zwrócono.|  
|`S_FALSE`|Brak tokenów do wyliczenia. W takim przypadku `pcTypeRefs` jest równa zero.|  
