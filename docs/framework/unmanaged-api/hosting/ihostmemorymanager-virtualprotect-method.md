...
Służy jako otoka logiczna dla odpowiadającej jej funkcji Win32. Implementacja Win32 `VirtualProtect` zmiany ochrony w regionie zatwierdzonych stron w wirtualnej przestrzeni adresowej procesu wywołującego.  
...
|HRESULT|Opis|  
|-------------|-----------------|  
|S_OK|`VirtualProtect` pomyślnie zwrócono.|  
