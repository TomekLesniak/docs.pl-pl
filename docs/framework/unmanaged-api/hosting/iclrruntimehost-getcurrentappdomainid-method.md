...
Pobiera liczbowy identyfikator <xref:System.AppDomain> , który jest aktualnie wykonywany.  
...
## <a name="parameters"></a>Parametry  
 ...
 `pdwAppDomainId`  
 określoną Liczbowy identyfikator <xref:System.AppDomain> , który jest aktualnie wykonywany.  
  
## <a name="return-value"></a>Wartość zwracana  
  
|HRESULT|Opis|  
|-------------|-----------------|  
|S_OK|`GetCurrentAppDomainId` pomyślnie zwrócono.|  
...
## <a name="remarks"></a>Uwagi  
 ...
 `pdwAppDomainId`Parametr jest ustawiony na wartość <xref:System.AppDomain.Id%2A> właściwości, <xref:System.AppDomain> w której jest wykonywany bieżący wątek.  
