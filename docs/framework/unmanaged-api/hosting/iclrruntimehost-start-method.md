...
## <a name="remarks"></a>Uwagi  
 ...
 W wielu scenariuszach nie jest konieczne wywoływanie `Start` , ponieważ środowisko uruchomieniowe zostanie zainicjowane automatycznie przy pierwszym żądaniu uruchomienia kodu zarządzanego. Można jednak użyć, `Start` Aby określić dokładnie czas inicjowania środowiska uruchomieniowego.  
