...
- Klasa profilera implementuje interfejsy [ICorProfilerCallback](icorprofilercallback-interface.md) i [ICorProfilerCallback2](icorprofilercallback2-interface.md) . W .NET Framework w wersji 2,0, profiler musi implementować `ICorProfilerCallback2` . Jeśli nie, nie `ICorProfilerCallback2` zostanie załadowany.  
