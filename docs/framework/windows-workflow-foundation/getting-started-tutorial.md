...
## <a name="in-this-section"></a>W tej sekcji  
 ...
 Opisuje sposób tworzenia schematów blokowych, sekwencyjnego i przepływu pracy automatu przy użyciu wbudowanych działań i działań niestandardowych w poprzednim samouczku.  
  
 [Instrukcje: Uruchamianie przepływu pracy](how-to-run-a-workflow.md)  
 Opisuje sposób wywoływania przepływu pracy ze środowiska hosta, przekazywania danych do i z przepływu pracy oraz jak wznawiać zakładki.  
  
 [Instrukcje: Tworzenie i uruchamianie długotrwałego przepływu pracy](how-to-create-and-run-a-long-running-workflow.md)  
 Opisuje sposób dodawania trwałości do aplikacji przepływu pracy.  
  
 [Instrukcje: Tworzenie niestandardowego uczestnika śledzenia](how-to-create-a-custom-tracking-participant.md)  
 Opisuje sposób tworzenia niestandardowych uczestników śledzenia i profilu śledzenia.  
 ...
 Opisuje, jak używać `WorkflowIdentity` do hostowania wielu wersji przepływu pracy obok siebie.  
