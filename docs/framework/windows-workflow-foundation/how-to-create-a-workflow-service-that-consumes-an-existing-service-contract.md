...
1. W programie Visual Studio wybierz pozycje **Plik**, **Nowy projekt**. Wybierz węzeł **WCF** w węźle **C#** w drzewie **szablonów** , a następnie wybierz szablon **aplikacja usługi przepływu pracy WCF** .  
...
1. Kliknij prawym przyciskiem myszy projekt w **Eksplorator rozwiązań** a następnie wybierz pozycję **Importuj kontrakt usługi**. W obszarze **\<Current Project>** Otwórz wszystkie węzły podrzędne i wybierz pozycję **IBookService**. Kliknij przycisk **OK**.  
