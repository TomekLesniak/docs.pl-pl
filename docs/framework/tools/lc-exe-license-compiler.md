...
1. Jeśli używasz licencjonowanej kontroli `MyCompany.Samples.LicControl1` zawartej w `Samples.DLL` w aplikacji o nazwie `HostApp.exe` *,* możesz utworzyć `HostAppLic.txt` , która zawiera poniższe elementy.  
