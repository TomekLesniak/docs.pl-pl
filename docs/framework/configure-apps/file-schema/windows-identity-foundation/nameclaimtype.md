...
|Atrybut|Opis|  
|---------------|-----------------|  
|wartość|Ciąg określający identyfikator URI, który reprezentuje typ zgłoszenia do użycia dla <xref:System.Security.Principal.IIdentity.Name%2A> właściwości. Wymagany.|  
