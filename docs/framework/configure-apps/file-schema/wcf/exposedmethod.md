...
## <a name="remarks"></a>Uwagi  
 ...
 Po uruchomieniu również ComSvcConfig.exe program generuje następujący kontrakt usługi z listą wymienionych wcześniej metod jako [\<exposedMethod>](exposedmethod.md) elementy.  
