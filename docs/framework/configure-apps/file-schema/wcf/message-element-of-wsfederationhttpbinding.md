...
---
# <a name="message-element-of-wsfederationhttpbinding"></a>\<message> elementu \<wsFederationHttpBinding>
...
|Element|Opis|  
|-------------|-----------------|  
|[\<security>](security-of-wsfederationhttpbinding.md)|Definiuje ustawienia zabezpieczeń dla powiązania.|  
