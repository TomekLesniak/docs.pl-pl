...
---
# <a name="add-of-contracttypenames"></a>\<add> dla \<contractTypeNames>
...
|Atrybut|Opis|  
|---------------|-----------------|  
|name|Ciąg określający nazwę typu kontraktu.|  
|namespace|Ciąg określający przestrzeń nazw typu kontraktu.|  
