...
---
# <a name="states-of-activitystatequery"></a>\<states> dla \<activityStateQuery>
...
|Element|Opis|  
|-------------|-----------------|  
|[\<state>](state-of-states.md)|Element konfiguracji zawiera stany subskrybowanego działania, dla którego należy obliczanie rekord śledzenia.|  
