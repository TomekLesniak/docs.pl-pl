...
|Nie|Nie dotyczy|Yes|Nie (domyślnie)|Szyfrowanie występuje tylko wtedy, gdy istnieje zweryfikowany certyfikat serwera, w przeciwnym razie próba połączenia nie powiedzie się.|  
|Nie|Nie dotyczy|Yes|Yes|Szyfrowanie zawsze występuje, ale może korzystać z certyfikatu serwera z podpisem własnym.|  
...
|Yes|Yes|Nie (domyślnie)|Ignorowane|Szyfrowanie zawsze występuje, ale może korzystać z certyfikatu serwera z podpisem własnym.|  
|Yes|Yes|Yes|Nie (domyślnie)|Szyfrowanie występuje tylko wtedy, gdy istnieje zweryfikowany certyfikat serwera; w przeciwnym razie próba połączenia nie powiedzie się.|  
|Yes|Yes|Yes|Yes|Szyfrowanie zawsze występuje, ale może korzystać z certyfikatu serwera z podpisem własnym.|  
