...
1. Wybierz przycisk **Utwórz**. Program Access pobiera bazę danych Northwind i przygotowuje plik.
...
## <a name="get-sql-server-management-studio"></a><a name="get_ssms"></a> Pobierz SQL Server Management Studio
...
Możesz również wyświetlać bazy danych i zarządzać nimi w zintegrowanym środowisku programistycznym (IDE) programu Visual Studio. W programie [Visual Studio](https://www.visualstudio.com/downloads/?utm_medium=microsoft&utm_source=docs.microsoft.com&utm_campaign=button+cta&utm_content=download+vs2019)Połącz się z bazą danych z programu **Eksplorator obiektów SQL Server**lub Utwórz połączenie danych z bazą danych w programie **Eksplorator serwera**. Otwórz te okienka Eksploratora z menu **Widok** .

## <a name="get-sql-server-express"></a><a name="get_sql"></a> Pobierz SQL Server Express
