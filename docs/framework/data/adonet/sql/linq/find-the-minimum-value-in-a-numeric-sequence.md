...
Użyj <xref:System.Linq.Enumerable.Min%2A> operatora, aby zwrócić minimalną wartość z sekwencji wartości liczbowych.  
...
## <a name="example"></a>Przykład  
 ...
 W poniższym przykładzie jest używane minimum, aby znaleźć wartość `Products` , która ma najniższą cenę jednostkową w każdej kategorii. Dane wyjściowe są uporządkowane według kategorii.  
