...
W programie <xref:System.Data.DataSet> można utworzyć skojarzenie między dwiema lub więcej kolumnami przez utworzenie relacji nadrzędny-podrzędny. Istnieją trzy sposoby reprezentowania relacji **zestawu danych** w schemacie języka definicji schematu XML (XSD):  
