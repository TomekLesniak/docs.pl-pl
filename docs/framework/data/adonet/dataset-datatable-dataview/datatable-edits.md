...
Po wprowadzeniu zmian w wartościach kolumn w <xref:System.Data.DataRow> , zmiany są natychmiast umieszczane w bieżącym stanie wiersza. <xref:System.Data.DataRowState>Następnie jest ustawiona na wartość **zmodyfikowano**, a zmiany zostaną zaakceptowane lub odrzucone przy użyciu <xref:System.Data.DataRow.AcceptChanges%2A> metod lub obiektu <xref:System.Data.DataRow.RejectChanges%2A> **DataRow**. Ten element **DataRow** zawiera również trzy metody, których można użyć w celu zawieszenia stanu wiersza podczas jego edytowania. Te metody to <xref:System.Data.DataRow.BeginEdit%2A> , <xref:System.Data.DataRow.EndEdit%2A> i <xref:System.Data.DataRow.CancelEdit%2A> .  
