...
## <a name="projecting-to-an-anonymous-type"></a>Projekcja do typu anonimowego  
 ...
 W przypadku zdefiniowania początkowej ścieżki zapytania w celu uwzględnienia pokrewnych obiektów przy użyciu <xref:System.Data.Objects.ObjectQuery%601.Include%2A> metody w <xref:System.Data.Objects.ObjectQuery%601> programie, a następnie użycie LINQ do zaprojektowania zwracanych obiektów do typu anonimowego, obiekty określone w metodzie include nie są uwzględniane w wynikach zapytania.  
