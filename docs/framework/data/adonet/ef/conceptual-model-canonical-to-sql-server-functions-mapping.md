...
|[Addmilisekund (wyrażenie)](./language-reference/date-and-time-canonical-functions.md)|`DATEADD(millisecond, number, date)`|  
...
|[Addnanosekunds (wyrażenie)](./language-reference/date-and-time-canonical-functions.md)|`DATEADD(nanosecond, number, date)`|  
...
|[Xmldatetimeoffset (Year, month, Day, Hour, minute, Second, TZoffset)](./language-reference/date-and-time-canonical-functions.md)|`datetimeoffset`Na serwerze zostanie utworzona sformatowana wartość.<br /><br /> Nieobsługiwane w SQL Server 2000 lub SQL Server 2005.|  
|[Czas trwania (godzina, minuta, sekunda)](./language-reference/date-and-time-canonical-functions.md)|`time`Na serwerze zostanie utworzona sformatowana wartość.<br /><br /> Nieobsługiwane w SQL Server 2000 lub SQL Server 2005.|  
...
|[TRUNCATE (wyrażenie)](./language-reference/date-and-time-canonical-functions.md)|W przypadku SQL Server 2000 i SQL Server 2005 `datetime` zostanie utworzona skrócona wartość sformatowana na serwerze. W przypadku SQL Server 2008 i nowszych wersji `datetime2` `datetimeoffset` na serwerze zostanie utworzona obcięta lub wartość.|  
...
|Funkcje kanoniczne|Funkcje SQL Server|  
|-------------------------|--------------------------|  
|[Średnia (wyrażenie)](./language-reference/aggregate-canonical-functions.md)|`AVG(expression)`|  
|[BigCount (wyrażenie)](./language-reference/aggregate-canonical-functions.md)|`BIGCOUNT(expression)`|  
...
|[RTrim (ciąg)](./language-reference/string-canonical-functions.md)|`RTRIM(string)`|  
