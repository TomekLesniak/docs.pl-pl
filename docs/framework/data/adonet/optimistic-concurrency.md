...
|-----------------|--------------------|-------------------|-----------------------|  
|CustID|101|101|101|  
|LastName (Nazwisko)|Smith|Smith|Smith|  
|FirstName (Imię)|Bob|Bob|Bob|  
...
|CustID|101|101|101|  
|LastName (Nazwisko)|Smith|Smith|Smith|  
|FirstName (Imię)|Bob|Tomasz|Robert|  
