...
Tabele w tym artykule zawierają wymagania dotyczące sprzętu, systemu operacyjnego i oprogramowania dla następujących wersji .NET Framework:
...
Aby uzyskać informacje o .NET Framework wersjach wcześniejszych niż .NET Framework 4,5, zobacz [.NET Framework wersje i zależności](../migration-guide/versions-and-dependencies.md).

Środowiska deweloperskie, które umożliwiają opracowywanie aplikacji dla .NET Framework, mają oddzielny zestaw wymagań.
...
.NET Framework wymaga uprawnień administratora do instalacji. Jeśli nie masz uprawnień administratora do komputera, na którym chcesz zainstalować .NET Framework, skontaktuj się z administratorem sieci.

## <a name="supported-client-operating-systems"></a>Obsługiwane klienckie systemy operacyjne

| System operacyjny | Obsługiwane wersje | Preinstalacja z systemem operacyjnym | Instalowane oddzielnie |
| ---------------- | ------------------ | ------------------------ | ---------------------- |
| Aktualizacja systemu Windows 10 maja 2020<br/> (wersja 2004) | 32-bitowe i 64-bitowe |  .NET Framework 4.8 | -- |
| Aktualizacja systemu Windows 10 listopad 2019<br/> (wersja 1909) | 32-bitowe i 64-bitowe |  .NET Framework 4.8 | -- |
| Aktualizacja systemu Windows 10 maja 2019<br/> (wersja 1903) | 32-bitowe i 64-bitowe |  .NET Framework 4.8 | -- |
| Aktualizacja systemu Windows 10 październik 2018<br/> (wersja 1809) | 32-bitowe i 64-bitowe |  .NET Framework 4.7.2 |  .NET Framework 4.8 |
| Aktualizacja systemu Windows 10 z kwietnia 2018<br/> (wersja 1803) | 32-bitowe i 64-bitowe |  .NET Framework 4.7.2 | .NET Framework 4.8|
...
| Aktualizacja systemu Windows 10 dla twórców<br/> (wersja 1703) | 32-bitowe i 64-bitowe |  .NET Framework 4.7 | .NET Framework 4.7.1<br/><br/> .NET Framework 4.7.2<br/><br/> .NET Framework 4.8 |
...
| Aktualizacja systemu Windows 10 listopad<br/> (wersja 1511) | 32-bitowe i 64-bitowe | .NET Framework 4.6.1 | .NET Framework 4.6.2 |
...
| Windows Vista z dodatkiem SP2|32-bitowe i 64-bitowe | -- | Program .NET Framework 4<br /><br /> .NET Framework 4.5<br /><br /> .NET Framework 4.5.1<br /><br /> .NET Framework 4.5.2<br /><br /> Program .NET Framework 4.6 |
| Windows XP |32-bitowe i 64-bitowe | -- | Program .NET Framework 4 |

 **Uwagi:**

- W systemach Windows 7 .NET Framework wymaga systemu Windows 7 z dodatkiem SP1. Jeśli korzystasz z systemu Windows 7 i jeszcze nie zainstalowano dodatku Service Pack 1, musisz to zrobić przed zainstalowaniem .NET Framework.

- .NET Framework 4,5 jest obsługiwane w Środowisko preinstalacji systemu Windows (Windows PE). Nie wszystkie funkcje są obsługiwane w środowisku Windows PE.

- .NET Framework 4 obsługuje także platformę IA64.
...
| System operacyjny | Obsługiwane wersje | Preinstalacja z systemem operacyjnym | Instalowane oddzielnie |
| ---------------- | ------------------ | ------------------------ | ---------------------- |
| Windows Server 2019 | 64-bitowa |  .NET Framework 4.7.2 |  .NET Framework 4.8 |
| System Windows Server w wersji 1809 | 64-bitowa |  .NET Framework 4.7.2 |  .NET Framework 4.8 |
| System Windows Server w wersji 1803 | 64-bitowa |  .NET Framework 4.7.2 |  .NET Framework 4.8 |
| System Windows Server w wersji 1709 | 64-bitowa | .NET Framework 4.7.1 |  .NET Framework 4.7.2|
| Windows Server 2016 | 64-bitowa | .NET Framework 4.6.2 |  .NET Framework 4.7<br/><br/> .NET Framework 4.7.1<br/><br/> .NET Framework 4.7.2<br/><br/> .NET Framework 4.8 |
| Windows Server 2012 z dodatkiem R2 | 64-bitowa | .NET Framework 4.5.1 | .NET Framework 4.5.2<br /><br /> Program .NET Framework 4.6<br /><br /> .NET Framework 4.6.1<br /><br /> .NET Framework 4.6.2<br /><br /> .NET Framework 4.7<br/><br/> .NET Framework 4.7.1<br/><br/> .NET Framework 4.7.2<br/><br/> .NET Framework 4.8 |
| Windows Server 2012 (64-bit Edition) | 64-bitowa| .NET Framework 4.5 | .NET Framework 4.5.1<br /><br /> .NET Framework 4.5.2<br /><br /> Program .NET Framework 4.6<br /><br /> .NET Framework 4.6.1<br /><br /> .NET Framework 4.6.2<br /><br /> .NET Framework 4.7<br/><br/>.NET Framework 4.7.1<br/><br/> .NET Framework 4.7.2<br/><br/> .NET Framework 4.8 |
| Windows Server 2008 R2 SP1|64-bitowa | -- | Program .NET Framework 4<br /><br /> .NET Framework 4.5<br /><br /> .NET Framework 4.5.1<br /><br /> .NET Framework 4.5.2<br /><br /> Program .NET Framework 4.6<br /><br /> .NET Framework 4.6.1<br /><br /> .NET Framework 4.6.2<br /><br /> .NET Framework 4.7<br/><br/>.NET Framework 4.7.1<br/><br/> .NET Framework 4.7.2<br/><br/> .NET Framework 4.8 |
| Windows Server 2008 SP2|32-bitowe i 64-bitowe | -- | Program .NET Framework 4<br /><br /> .NET Framework 4.5<br /><br /> .NET Framework 4.5.1<br /><br /> .NET Framework 4.5.2<br /><br /> Program .NET Framework 4.6 |
