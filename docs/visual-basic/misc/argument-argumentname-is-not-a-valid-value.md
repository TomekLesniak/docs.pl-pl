...
1. Sprawdź wartość argumentu.  
  
2. Jeśli argument jest dostarczany przez obliczenie, sprawdź wartości, które są przetwarzane przez obliczenia.  
