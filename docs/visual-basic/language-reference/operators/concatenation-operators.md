...
ms.locfileid: "90867117"
---
# <a name="concatenation-operators-visual-basic"></a>Concatenation — Operatory (Visual Basic)

Poniżej przedstawiono operatory łączenia zdefiniowane w Visual Basic.  
