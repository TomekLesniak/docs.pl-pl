...
|`Decimal`|Liczba dziesiętna|Pojedynczy|Double|Liczba dziesiętna|  
|`Single`|Pojedynczy|Pojedynczy|Double|Pojedynczy|  
|`Double`|Double|Double|Double|Double|  
|Dowolny typ liczby całkowitej|Liczba dziesiętna|Pojedynczy|Double|Double|  
...
|Jednostk `+`|Wybierak|SByte|Byte|Wybierak|UShort|Integer|UInteger —|Długo|ULong|  
|Jednostk `–`|Wybierak|SByte|Wybierak|Wybierak|Integer|Integer|Długo|Długo|Liczba dziesiętna|  
...
|---|---|---|---|---|---|---|---|---|---|  
||`Boolean`|`SByte`|`Byte`|`Short`|`UShort`|`Integer`|`UInteger`|`Long`|`ULong`|  
|`<<`, `>>`|Wybierak|SByte|Byte|Wybierak|UShort|Integer|UInteger —|Długo|ULong|  
...
|---|---|---|---|---|---|---|---|---|---|  
||`Boolean`|`SByte`|`Byte`|`Short`|`UShort`|`Integer`|`UInteger`|`Long`|`ULong`|  
|`Boolean`|Wybierak|SByte|Wybierak|Wybierak|Integer|Integer|Długo|Długo|Liczba dziesiętna|  
|`SByte`|SByte|SByte|Wybierak|Wybierak|Integer|Integer|Długo|Długo|Liczba dziesiętna|  
|`Byte`|Wybierak|Wybierak|Byte|Wybierak|UShort|Integer|UInteger —|Długo|ULong|  
|`Short`|Wybierak|Wybierak|Wybierak|Wybierak|Integer|Integer|Długo|Długo|Liczba dziesiętna|  
|`UShort`|Integer|Integer|UShort|Integer|UShort|Integer|UInteger —|Długo|ULong|  
|`Integer`|Integer|Integer|Integer|Integer|Integer|Integer|Długo|Długo|Liczba dziesiętna|  
|`UInteger`|Długo|Długo|UInteger —|Długo|UInteger —|Długo|UInteger —|Długo|ULong|  
|`Long`|Długo|Długo|Długo|Długo|Długo|Długo|Długo|Długo|Liczba dziesiętna|  
|`ULong`|Liczba dziesiętna|Liczba dziesiętna|ULong|Liczba dziesiętna|ULong|Liczba dziesiętna|ULong|Liczba dziesiętna|ULong|  
...
|---|---|---|---|---|---|---|---|---|---|  
||`Boolean`|`SByte`|`Byte`|`Short`|`UShort`|`Integer`|`UInteger`|`Long`|`ULong`|  
|`Boolean`|Wybierak|SByte|Wybierak|Wybierak|Integer|Integer|Długo|Długo|Długo|  
|`SByte`|SByte|SByte|Wybierak|Wybierak|Integer|Integer|Długo|Długo|Długo|  
|`Byte`|Wybierak|Wybierak|Byte|Wybierak|UShort|Integer|UInteger —|Długo|ULong|  
|`Short`|Wybierak|Wybierak|Wybierak|Wybierak|Integer|Integer|Długo|Długo|Długo|  
|`UShort`|Integer|Integer|UShort|Integer|UShort|Integer|UInteger —|Długo|ULong|  
|`Integer`|Integer|Integer|Integer|Integer|Integer|Integer|Długo|Długo|Długo|  
|`UInteger`|Długo|Długo|UInteger —|Długo|UInteger —|Długo|UInteger —|Długo|ULong|  
...
|---|---|---|---|---|---|---|---|---|---|  
||`Boolean`|`SByte`|`Byte`|`Short`|`UShort`|`Integer`|`UInteger`|`Long`|`ULong`|  
|`Not`|Boolean|SByte|Byte|Wybierak|UShort|Integer|UInteger —|Długo|ULong|  
...
|---|---|---|---|---|---|---|---|---|---|  
||`Boolean`|`SByte`|`Byte`|`Short`|`UShort`|`Integer`|`UInteger`|`Long`|`ULong`|  
|`Boolean`|Boolean|SByte|Wybierak|Wybierak|Integer|Integer|Długo|Długo|Długo|  
|`SByte`|SByte|SByte|Wybierak|Wybierak|Integer|Integer|Długo|Długo|Długo|  
|`Byte`|Wybierak|Wybierak|Byte|Wybierak|UShort|Integer|UInteger —|Długo|ULong|  
|`Short`|Wybierak|Wybierak|Wybierak|Wybierak|Integer|Integer|Długo|Długo|Długo|  
|`UShort`|Integer|Integer|UShort|Integer|UShort|Integer|UInteger —|Długo|ULong|  
