...
|Jedno wyrażenie jest [pojedynczym](../data-types/single-data-type.md) typem danych, a drugi nie jest [Double](../data-types/double-data-type.md)|`Single`|  
|Jedno wyrażenie jest typu danych [dziesiętnych](../data-types/decimal-data-type.md) , a drugi nie jest [pojedynczym](../data-types/single-data-type.md) lub [podwójnym](../data-types/double-data-type.md) .|`Decimal`|  
|Jedno wyrażenie jest [podwójnym](../data-types/double-data-type.md) typem danych|`Double`|  
