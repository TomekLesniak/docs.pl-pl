...
---
# <a name="bc40025-type-of-member-membername-is-not-cls-compliant"></a>BC40025: typ elementu członkowskiego " \<membername> " jest niezgodny ze specyfikacją CLS

Typ danych określony dla tego elementu członkowskiego nie jest częścią [niezależności od języka i składników Language-Independent](../../../standard/language-independence-and-language-independent-components.md) (CLS). Nie jest to błąd w składniku, ponieważ .NET Framework i Visual Basic obsługują ten typ danych. Jednak inny składnik zapisany w kodzie zgodnym ze specyfikacją CLS może nie obsługiwać tego typu danych. Taki składnik może nie być w stanie pomyślnie korzystać z składnika.
