...
## <a name="passing-readonly-properties-of-controls-byref"></a><a name="vbconinteroperabilitymarshalinganchor11"></a> Przekazywanie właściwości ReadOnly formantów ByRef  
 ...
 Jeśli masz dostęp do wywoływanej procedury, możesz uniknąć tego błędu za pomocą `ByVal` słowa kluczowego, aby zadeklarować parametry akceptujące `ReadOnly` właściwości. Na przykład:  
