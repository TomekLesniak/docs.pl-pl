...
#### <a name="shared-methods"></a>Metody udostępnione  
 ...
 Metoda wspólna to metoda, która jest uruchamiana z `String` samej klasy i nie wymaga wystąpienia tej klasy do działania. Metody te mogą być kwalifikowana nazwą klasy ( `String` ), a nie z wystąpieniem `String` klasy. Na przykład:  
