...
## <a name="in-this-section"></a>W tej sekcji  
 ...
 Zawiera ogólne wprowadzenie do rodzajów aplikacji, które można napisać, oraz rodzajów problemów, które można rozwiązać za pomocą zapytań LINQ.  
  
 [Wprowadzenie do programu LINQ w Visual Basic](getting-started-with-linq.md)  
 W tym artykule opisano podstawowe fakty, które należy znać, aby zrozumieć Visual Basic dokumentację i przykłady.  
  
 [Środowisko IDE i narzędzia programu Visual Studio obsługujące składnik LINQ (Visual Basic)](visual-studio-ide-and-tools-support-for-linq.md)  
 Opisuje Object Relational Designer programu Visual Studio, obsługę debugera dla zapytań i inne funkcje środowiska IDE związane z LINQ.  
 ...
 Udostępnia punkt wejścia dokumentacji dotyczącej LINQ to DataSet, LINQ to SQL i LINQ to Entities. LINQ to DataSet umożliwia tworzenie bogatszych możliwości zapytań w <xref:System.Data.DataSet> programie za pomocą tej samej funkcji zapytania, która jest dostępna dla innych źródeł danych. LINQ to SQL udostępnia infrastrukturę czasu wykonywania do zarządzania danymi relacyjnymi jako obiekty. LINQ to Entities umożliwia deweloperom Pisanie zapytań względem modelu koncepcyjnego Entity Framework przy użyciu języka C#.  
  
 [Włączanie źródła danych do zapytań LINQ](enabling-a-data-source-for-linq-querying.md)  
 Zawiera wprowadzenie do niestandardowych dostawców LINQ, drzew wyrażeń LINQ i inne sposoby rozszerzając LINQ.
