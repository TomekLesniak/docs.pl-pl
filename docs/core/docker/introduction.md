...
Aby uzyskać więcej informacji na temat instalowania platformy Docker, zobacz stronę pobierania dla programu [Docker Desktop: wersja Community](https://www.docker.com/products/docker-desktop).
...
- [Dowiedz się, jak konteneryzowanie aplikację .NET Core.](build-container.md)
