...
Następujące istotne zmiany w ASP.NET Core 3,0, 3,1 i 5,0 są udokumentowane na tej stronie:
...
- [Blazor: Zaktualizowano logikę walidacji dla statycznych zasobów sieci Web](#blazor-updated-validation-logic-for-static-web-assets)
