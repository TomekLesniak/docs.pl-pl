...
Publiczne składowe w programie `RenderTreeFrame` są zdefiniowane jako pola. Przykład: `renderTreeFrame.Sequence` i `renderTreeFrame.ElementName`.

## <a name="new-behavior"></a>Nowe zachowanie

Publiczne składowe w `RenderTreeFrame` programie są zdefiniowane jako właściwości o takich samych nazwach jak poprzednio. Przykład: `renderTreeFrame.Sequence` i `renderTreeFrame.ElementName`.
