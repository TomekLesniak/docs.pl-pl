...
---
# <a name="compiler-error-cs0428"></a>Błąd kompilatora CS0428
Nie można przekonwertować grupy metod "identifier" na typ Niedelegowany "Type".  Czy chodziło o wywołanie metody?  
  
 Ten błąd występuje podczas konwertowania grupy metod na typ inny niż delegata lub próba wywołania metody bez używania nawiasów.  
  
## <a name="example"></a>Przykład  
 Poniższy przykład generuje CS0428:  
