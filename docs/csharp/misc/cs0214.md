...
Wskaźniki i bufory o ustalonym rozmiarze mogą być używane tylko w niebezpiecznym kontekście  
 ...
 Wskaźników można używać tylko z [niebezpiecznym](../language-reference/keywords/unsafe.md) słowem kluczowym. Aby uzyskać więcej informacji, zobacz artykuł [niebezpieczny kod i wskaźniki](../programming-guide/unsafe-code-pointers/index.md).  
