...
element "member" jest przestarzały  
 ...
 Projektant klas oznaczył element członkowski z [nieaktualnym atrybutem](../language-reference/attributes/general.md#obsolete-attribute). Oznacza to, że element członkowski może nie być obsługiwany w przyszłej wersji klasy.  
