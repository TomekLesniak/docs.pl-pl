...
Nie można powiązać delegata z elementem "member", ponieważ jest to element członkowski elementu "Type"  
  
 Nie można powiązać delegatów z elementami członkowskimi `Nullable` typów wartości.  
