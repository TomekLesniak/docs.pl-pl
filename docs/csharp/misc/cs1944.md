...
Drzewo wyrażenia nie może zawierać niebezpiecznej operacji wskaźnika  
 ...
 Drzewa wyrażeń nie obsługują typów wskaźników <xref:System.Linq.Expressions.Expression%601.Compile%2A?displayProperty=nameWithType> , ponieważ metoda może tworzyć tylko kod możliwy do zweryfikowania. Zobacz komentarze.  
