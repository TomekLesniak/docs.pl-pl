...
W tym artykule opisano `switch` wyrażenie wprowadzone w języku C# 8,0. Aby uzyskać informacje na temat `switch` instrukcji, zobacz artykuł w [ `switch` instrukcji](../keywords/switch.md) w sekcji [instrukcje](../keywords/index.md) .
