...
Nie używaj atrybutu "System. Runtime. CompilerServices. FixedBuffer". Zamiast tego użyj modyfikatora pola "Fixed".  
 ...
 Ten błąd występuje w sekcji niebezpiecznego kodu, która zawiera deklarację tablicy o ustalonym rozmiarze podobną do deklaracji pola. Nie używaj tego atrybutu. Zamiast tego należy użyć słowa kluczowego `fixed` .  
