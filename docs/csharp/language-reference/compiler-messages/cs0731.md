...
Typ przesyłania dalej dla typu "Type" w zestawie "Assembly" powoduje wystąpienie cyklu  
  
 Ten błąd może wystąpić tylko z nieprawidłowo sformułowanymi zaimportowanymi metadanymi. Nie może występować tylko w języku C#.  
...
## <a name="example"></a>Przykład  
 ...
 Najpierw Skompiluj. Pliki IL jako biblioteki, a następnie Skompiluj kod CS odwołujący się do tych dwóch plików.  
