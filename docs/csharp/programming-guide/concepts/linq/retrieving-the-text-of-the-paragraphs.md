...
Ten przykład kompiluje się w poprzednim przykładzie, [pobierając akapity i ich style (C#)](./retrieving-the-paragraphs-and-their-styles.md). Ten nowy przykład pobiera tekst każdego akapitu w postaci ciągu.  
 ...
 Te zapytania, które są powiązane ze sobą, wykorzystują model przetwarzania, który jest szczegółowo rozpatrywany w [samouczku tematu: Łączenie łańcuchowe zapytań (C#)](deferred-execution-and-lazy-evaluation-in-linq-to-xml.md).  
...
- [Wykonywanie odroczone i Ocena z opóźnieniem w LINQ to XML (C#)](./deferred-execution-and-lazy-evaluation-in-linq-to-xml.md)
