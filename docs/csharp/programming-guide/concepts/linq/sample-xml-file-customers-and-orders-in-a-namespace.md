...
description: Ten plik XML jest używany w różnych przykładach w dokumentacji LINQ to XML. Plik zawiera klientów i zamówienia. KOD XML znajduje się w przestrzeni nazw.
ms.date: 07/20/2015
...
ms.locfileid: "87302545"
---
# <a name="sample-xml-file-customers-and-orders-in-a-namespace"></a><span data-ttu-id="702f1-105">Przykładowy plik XML: klienci i zamówienia w przestrzeni nazw</span><span class="sxs-lookup"><span data-stu-id="702f1-105">Sample XML File: Customers and Orders in a Namespace</span></span>
<span data-ttu-id="702f1-106">Następujący plik XML jest używany w różnych przykładach w [!INCLUDE[sqltecxlinq](~/includes/sqltecxlinq-md.md)] dokumentacji.</span><span class="sxs-lookup"><span data-stu-id="702f1-106">The following XML file is used in various examples in the [!INCLUDE[sqltecxlinq](~/includes/sqltecxlinq-md.md)] documentation.</span></span> <span data-ttu-id="702f1-107">Ten plik zawiera klientów i zamówienia.</span><span class="sxs-lookup"><span data-stu-id="702f1-107">This file contains customers and orders.</span></span> <span data-ttu-id="702f1-108">KOD XML znajduje się w przestrzeni nazw.</span><span class="sxs-lookup"><span data-stu-id="702f1-108">The XML is in a namespace.</span></span>  
  
## <a name="customersordersinnamespacexml"></a><span data-ttu-id="702f1-109">CustomersOrdersInNamespace.xml</span><span class="sxs-lookup"><span data-stu-id="702f1-109">CustomersOrdersInNamespace.xml</span></span>  
