...
4. Na karcie **przeglądanie** przejdź do folderu, w którym są zainstalowane biblioteki IronPython. Na przykład C:\Program Files\IronPython 2,6 for .NET 4,0. Wybierz biblioteki **IronPython.dll**, **IronPython.Modules.dll**, **Microsoft.Scripting.dll**i **Microsoft.Dynamic.dll** . Kliknij przycisk **OK**.  
