...
description: Dowiedz się, jak używać delegatów. Delegaty są zorientowane obiektowo, typu bezpieczne i bezpieczne typu, który bezpiecznie hermetyzuje metodę.
ms.date: 07/20/2015
helpviewer_keywords:
