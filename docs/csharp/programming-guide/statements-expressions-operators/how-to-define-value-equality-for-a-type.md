...
> [!NOTE]
> Począwszy od języka C# 9,0, można użyć rekordów do uzyskania semantyki równości wartości bez niepotrzebnego kodu standardowego.
...
## <a name="struct-example"></a>Przykład struktury
