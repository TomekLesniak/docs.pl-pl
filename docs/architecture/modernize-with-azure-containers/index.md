...
Firma Microsoft i znaki towarowe wymienione na <https://www.microsoft.com> stronie "znaki towarowe" są znakami towarowymi grupy firm Microsoft. Wszystkie inne znaczniki są własnością odpowiednich właścicieli.
...
| **Infrastruktura chmury — gotowe** <br /> *Migrowanie metodą „lift-and-shift”* | **Zoptymalizowane pod kątem chmury** <br /> *Modernizowanie* | **Chmura — natywna** <br /> *Modernizacja, ponowne tworzenie architektury i ponowne zapisywanie* |
|---|---|---|
