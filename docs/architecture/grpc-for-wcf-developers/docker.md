...
| Obraz | Opis |
| ----- | ----------- |
| [mcr.microsoft.com/dotnet/core/sdk](https://hub.docker.com/_/microsoft-dotnet-core-sdk/) | Do kompilowania aplikacji za pomocą programu `docker build` . Nie do użycia w środowisku produkcyjnym. |
