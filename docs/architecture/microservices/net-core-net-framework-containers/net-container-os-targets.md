...
| Obraz | Komentarze |
|-------|----------|
| mcr.microsoft.com/dotnet/runtime:3.1 | Architektura .NET Core 3,1 — Obsługa systemu Linux i Windows nano Server w zależności od hosta platformy Docker. |
| mcr.microsoft.com/dotnet/aspnet:3.1 | Wieloarchitektura ASP.NET Core 3,1: obsługuje systemy Linux i Windows nano Server w zależności od hosta platformy Docker. <br/> Obraz aspnetcore ma kilka optymalizacji dla ASP.NET Core. |
| mcr.microsoft.com/dotnet/aspnet:3.1-buster-slim | Środowisko uruchomieniowe programu .NET Core 3,1 — tylko w systemie Linux Debian dystrybucji |
| mcr.microsoft.com/dotnet/aspnet:3.1-nanoserver-1809 | Środowisko uruchomieniowe programu .NET Core 3,1 — tylko w systemie Windows nano Server (system Windows Server w wersji 1809) |

## <a name="additional-resources"></a>Dodatkowe zasoby

- **BitmapDecoder nie powiodła się z powodu braku WindowsCodecsExt.dll (problem z usługą GitHub)**  
