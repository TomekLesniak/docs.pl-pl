...
- Zdalne relacyjne bazy danych, takie jak [Azure SQL Database](https://azure.microsoft.com/services/sql-database/) lub NoSQL, takie jak [Azure Cosmos DB](/azure/cosmos-db/introduction), lub usługi pamięci podręcznej, takie jak [Redis](https://redis.io/).
