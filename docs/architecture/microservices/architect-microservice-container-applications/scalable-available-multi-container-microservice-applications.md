...
Ta funkcja jest oparta na prefiksach adresów URL, więc w przypadku używania dowolnego prefiksu obszaru dev w adresie URL żądanie jest obsługiwane z mikrousługi docelowej, jeśli istnieje w przestrzeni dev, w przeciwnym razie jest przekazywane do pierwszego wystąpienia mikrousługi docelowej w hierarchii, a ostatecznie do głównego obszaru deweloperskiego w górnej części.
...
Aby uzyskać więcej informacji, zapoznaj się z artykułem [opracowywanie zespołu w programie Azure dev Spaces](/azure/dev-spaces/team-development-netcore).
