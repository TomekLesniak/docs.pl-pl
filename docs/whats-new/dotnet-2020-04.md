...
- [Konfiguracja aplikacji](../architecture/blazor-for-web-forms-developers/config.md)  -  Blazor Konfiguracja książki elektronicznej
...
- [Historia języka C \# ](../csharp/whats-new/csharp-version-history.md) -Dodaj najnowsze opisy wersji języka
...
- [Windows Presentation Foundation (WPF) dla programu .NET Core](/dotnet/desktop/wpf/) — Dodawanie strony docelowej dla programu Desktop WPF
...
- [Udoskonalenia ułatwień dostępu w formantach Windows Forms dla programu .NET Core 3,0](/dotnet/desktop/winforms/windows-forms-accessibility-improvements) — Dodawanie dokumentacji dostępności dla podstawowych WinForms
