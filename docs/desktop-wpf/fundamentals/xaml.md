...
W poniższych sekcjach objaśniono podstawowe formy składni XAML i przedstawiono przykład krótkiego znacznika. Te sekcje nie są przeznaczone do przekazywania pełnych informacji o poszczególnych formularzach składni, takich jak te reprezentowane w systemie typów zapasowych. Aby uzyskać więcej informacji na temat składni języka XAML, zobacz [Szczegóły składni języka XAML](/dotnet/desktop/wpf/advanced/xaml-syntax-in-detail).
...
Aby uzyskać więcej informacji na temat składni języka XAML, zobacz [Szczegóły składni języka XAML](/dotnet/desktop/wpf/advanced/xaml-syntax-in-detail).
...
Najpopularniejsze rozszerzenia znaczników używane w programowaniu aplikacji WPF są [`Binding`](/dotnet/desktop/wpf/advanced/binding-markup-extension) używane na potrzeby wyrażeń powiązań danych oraz odwołania do zasobów [`StaticResource`](/dotnet/desktop/wpf/advanced/staticresource-markup-extension) i [`DynamicResource`](/dotnet/desktop/wpf/advanced/dynamicresource-markup-extension) . Używając rozszerzeń znaczników, można użyć składni atrybutów, aby podać wartości właściwości, nawet jeśli ta właściwość nie obsługuje ogólnie składni atrybutów. Rozszerzenia znaczników często używają typów wyrażeń pośrednich do włączania funkcji, takich jak odłożone wartości lub odwoływania się do innych obiektów, które są obecne tylko w czasie wykonywania.
...
Aby zapoznać się z listą odwołań wszystkich rozszerzeń znaczników dla języka XAML zaimplementowanego w środowisku WPF, zobacz [rozszerzenia XAML WPF](/dotnet/desktop/wpf/advanced/wpf-xaml-extensions). Aby zapoznać się z listą odwołań do rozszerzeń znaczników, które są zdefiniowane przez system. XAML i są bardziej szeroko dostępne dla implementacji platformy .NET Core XAML, zobacz [przestrzeń nazw XAML (x:) Funkcje językowe](../xaml-services/namespace-language-features.md). Aby uzyskać więcej informacji o pojęciach dotyczących rozszerzeń znaczników, zobacz [rozszerzenia znaczników i XAML WPF](/dotnet/desktop/wpf/advanced/markup-extensions-and-wpf-xaml).
...
Aby uzyskać więcej informacji na temat konwersji typów, zobacz [TypeConverters i XAML](/dotnet/desktop/wpf/advanced/typeconverters-and-xaml).
...
Aby uzyskać więcej informacji na temat typów niestandardowych w języku XAML, zobacz sekcję [XAML i klasy niestandardowe dla WPF](/dotnet/desktop/wpf/advanced/xaml-and-custom-classes-for-wpf).

Aby uzyskać więcej informacji o tym, jak są powiązane przestrzenie nazw XML i przestrzenie nazw kodu w zestawach, zobacz [przestrzenie nazw XAML i mapowanie przestrzeni nazw dla WPF XAML](/dotnet/desktop/wpf/advanced/xaml-namespaces-and-namespace-mapping-for-wpf-xaml).
...
- [Szczegóły składni XAML](/dotnet/desktop/wpf/advanced/xaml-syntax-in-detail)
...
- [Rozszerzenia WPF XAML](/dotnet/desktop/wpf/advanced/wpf-xaml-extensions)
- [Przegląd Elementy bazy](/dotnet/desktop/wpf/advanced/base-elements-overview)
