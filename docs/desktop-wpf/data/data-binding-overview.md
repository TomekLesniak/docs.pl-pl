...
- Chociaż nie pokazano na rysunku, należy zauważyć, że obiekt źródłowy powiązania nie jest ograniczony do niestandardowego obiektu .NET. Powiązanie danych WPF obsługuje dane w postaci obiektów .NET i XML. Aby udostępnić przykłady, Źródło powiązania może być obiektem <xref:System.Windows.UIElement> dowolnego obiektu listy, ADO.NET lub usługami sieci Web lub elementem XmlNode, który zawiera dane XML. Aby uzyskać więcej informacji, zobacz [Omówienie źródeł powiązań](/dotnet/desktop/wpf/data/binding-sources-overview).
...
Aby zapoznać się z przykładem, zobacz [How to: Control, kiedy tekst TextBox aktualizuje Źródło](/dotnet/desktop/wpf/data/how-to-control-when-the-textbox-text-updates-the-source).
...
Aby uzyskać więcej informacji na temat składni deklaracji powiązania i Przykłady sposobu konfigurowania powiązania w kodzie, zobacz temat [Omówienie deklaracji powiązań](/dotnet/desktop/wpf/data/binding-declarations-overview).
...
- [Pobieranie obiektu wiążącego z powiązanej własności docelowej](/dotnet/desktop/wpf/data/how-to-get-the-binding-object-from-a-bound-target-property)

- [Określ, kiedy tekst TextBox aktualizuje Źródło](/dotnet/desktop/wpf/data/how-to-control-when-the-textbox-text-updates-the-source)
...
Aby uzyskać widok domyślny, należy użyć <xref:System.Windows.Data.CollectionViewSource.GetDefaultView%2A> metody. Aby zapoznać się z przykładem, zobacz temat [pobieranie widoku domyślnego kolekcji danych](/dotnet/desktop/wpf/data/how-to-get-the-default-view-of-a-data-collection).
...
Aby uzyskać więcej informacji na temat szablonów danych, zobacz [Omówienie tworzenia szablonów danych](/dotnet/desktop/wpf/data/data-templating-overview).
...
Aby zapoznać się z przykładem sposobu zapewnienia logiki do sprawdzania poprawności wszystkich kontrolek w oknie dialogowym, zobacz sekcję niestandardowe okna dialogowe w oknach dialogowych [Przegląd](/dotnet/desktop/wpf/app-development/dialog-boxes-overview).
...
- <xref:System.Windows.Controls.DataErrorValidationRule>
- [Powiąż z wynikami zapytania LINQ](/dotnet/desktop/wpf/data/how-to-bind-to-the-results-of-a-linq-query)
- [Powiązanie danych](/dotnet/desktop/wpf/advanced/optimizing-performance-data-binding)
- [Pokaz powiązania danych][data-binding-demo]
- [Artykuły z poradami](/dotnet/desktop/wpf/data/data-binding-how-to-topics)
- [Wiązanie ze źródłem danych ADO.NET](/dotnet/desktop/wpf/data/how-to-bind-to-an-ado-net-data-source)
